...
```{r bills5, fig.cap="Percentage of teenage pregnancy and motherhood by age", echo = FALSE, fig.height=9, fig.width=5}
#subset the dataset by rows containing residence
Age<- dhs1998[2:6,]

# plot Percentage of who are mothers
a1 <- ggplot(Age, aes(BG_inf, PT_Mom)) + xlab("Age") +ylab("Percentage of who are mothers")+geom_col()

# plot Percentage of who have begun child-bearing
a2 <- ggplot(Age, aes(BG_inf, PT_bear)) + xlab("Age") +ylab("Percentage of who have begun child-bearing")+geom_col()

# plot Percentage of who are pregnant with first child
a3 <- ggplot(Age, aes(BG_inf, PT_Pgt)) + xlab("Age") +ylab("Percentage of who are pregnant with first child")+geom_col()
